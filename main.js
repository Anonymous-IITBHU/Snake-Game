...
function gameEngine(){
    ...
    // increment score and regenerating the food
    if(snakeArr[0].y === food.y && snakeArr[0].x === food.x){
        ...
        {
            hiscoreval = score ;
            localStorage.setItem("myScore", JSON.stringify(hiscoreval));
...
{
    hiscoreval = JSON.parse(myScore);
    hiscoreBox.innerHTML = "HiScore: "+ myScore;
}
